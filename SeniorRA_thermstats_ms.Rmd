...
using("dplyr",
      "ggmap", "rasterVis", "viridis", 
      "ggpubr", "egg", "gridExtra")
...
(ref:cap-1) Overview of the main `ThermStats` functions and functionality.

```{r fig-1, fig.cap= "(ref:cap-1)", fig.pos = 'H'}
